...
const require_use_cascader_safe_area = require("./use-cascader-safe-area.cjs");
...
function CascaderColumns({ data, activePath, value, keyboardNav, withCheckIcon, checkIconPosition, renderOption, columnWidth, maxDisplayedLevels, previousLevelsControlLabel, nextLevelsControlLabel, maxDropdownHeight, nothingFoundMessage, getStyles, unstyled, scrollAreaProps, onOptionClick, onOptionMouseEnter, onColumnsMouseLeave, onPointerActivity, listId, safeAreaPolygon }) {
	const allColumns = require_get_cascader_columns.getCascaderColumns(data, activePath);
	...
	const [windowState, setWindowState] = (0, react.useState)({
		key: activePathKey,
		offset: 0
	});
	...
	const check = showCheckIcon ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(require_CheckIcon.CheckIcon, { ...getStyles("columnOptionCheck") }) : null;
	const columnRefs = (0, react.useRef)({});
	const safeArea = require_use_cascader_safe_area.useCascaderSafeArea({
		safeAreaPolygon,
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		...
		children: [
			hiddenBefore > 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(require_UnstyledButton.UnstyledButton, {
				...
				children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(require_AccordionChevron.AccordionChevron, {})
			}),
				...
				return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
					...
					children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(require_ScrollArea.ScrollArea.Autosize, {
						...
						children: options.length === 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							...
							const hasChildren = require_get_cascader_columns.cascaderOptionHasChildren(option);
			...
			hiddenAfter > 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(require_UnstyledButton.UnstyledButton, {
				...getStyles("columnsOverflow"),
				"data-position": "end",
				tabIndex: -1,
				unstyled,
...
//#endregion
exports.CascaderColumns = CascaderColumns;
exports.getCascaderOptionId = getCascaderOptionId;

//# sourceMappingURL=CascaderColumns.cjs.map