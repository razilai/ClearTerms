	...
	const pills = visiblePills.map((item, index) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(require_Pill.Pill, {
		...
		onRemove: () => {
			if (isCheckbox) {
				...
				setValue(require_get_checked_values_by_strategy.checkedToValue(newInternal, data, checkedStrategy));
