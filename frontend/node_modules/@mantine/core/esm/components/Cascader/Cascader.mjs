...
import { useCascader } from "./use-cascader.mjs";
import Cascader_module_default from "./Cascader.module.mjs";
...
function defaultRenderSearchOption(options, separator) {
	return options.map((option, index) => /* @__PURE__ */ jsxs(Fragment, { children: [index > 0 && /* @__PURE__ */ jsxs("span", {
...
const Cascader = factory((_props) => {
	...
	const getStyles = useStyles({
		name: "Cascader",
		classes: Cascader_module_default,
		props,
		classNames,
		styles,
		unstyled,
	...
	const dropdown = /* @__PURE__ */ jsx(Combobox.Dropdown, {
		...
		children: showFlatList ? /* @__PURE__ */ jsxs(Combobox.Options, {
				...
				children: flatListItems.map((flatPath, index) => {
					...
					return /* @__PURE__ */ jsx(Combobox.Option, {
						...
						children: /* @__PURE__ */ jsxs("span", {
							...
							children: [
								active && withCheckIcon && checkIconPosition === "left" && /* @__PURE__ */ jsx(CheckIcon, { ...getStyles("columnOptionCheck") }),
								/* @__PURE__ */ jsx("span", {
			...
			}), flatListItems.length === 0 && nothingFoundMessage && /* @__PURE__ */ jsx(Combobox.Empty, { children: nothingFoundMessage })]
		}) : /* @__PURE__ */ jsx(CascaderColumns, {
			data,
